...
inputpath    = check_inputpath(cfg.bdt_lh_opts_nleptfail['inputPath']) 
outputpath   = set_outputpath(cfg.bdt_lh_opts_nleptfail['outputPath'])
...
decays_dict={'signal':signal_decays,'heavy_background':heavy_bkg, 'full_background':background_decays} #'light_background':light_bkg, 
...
df.to_pickle(os.path.join(outputpath,'bdt_lh_dataframe_nlept_fail.pkl'))
