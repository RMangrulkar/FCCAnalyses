...
with open(os.path.join(full_save_path,f'full_sample_medium_bdtlh_cut_efficiencies.log'), 'a') as log_file:
    log_file.write(f'Medium BDT_lh cut at: {cut_val} for 1-P(h) and 1-P(l)\n')
...
for sample in samples:
    ...
    with open(os.path.join(full_save_path,f'full_samples_medium_bdtlh_cut_efficiencies.log'), 'a') as log_file:
