...
#################################
print(f"{30*'-'}")
print(f"CREATING AND SAVING df FOR BDTh TRAINING")
print(f"{30*'-'}\n")
...
df.to_pickle(os.path.join(outputpath,'bdth_dataframe.pkl'))
print("DataFrame saved successfully!")

# Write key info about df to log file
with open(os.path.join(outputpath,'bdth_dataframe_info.log'), 'a') as log_file:
