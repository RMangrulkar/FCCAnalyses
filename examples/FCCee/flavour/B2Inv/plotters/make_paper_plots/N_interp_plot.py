...
opt_path = 'outputs/B2lnu_backgrounds_included/BDTlh_baseline_plus_cut_optimisation/no_smoothing/0999/8x8xmidstats_4x4lowstats/incl_B2lnu/all_oneprong_tau'
...
BF =  7.806964487492601e-09#7.2309062308486705e-09#8.952995613376855e-09 #6.974125279294959e-09
print(f'BF = {BF}')
...
bdt_lh_cut_opt_significance_exclusive_backgrounds.likelihood_model_builder_extra_bkgs_nodata(interp_N_dict, cut_opt_samples=samples_for_cut_opt, componenets_in_FOM=['hadronic_background','combined_signal', 'B2lnu_background_combined'], model_all_1prong_tau = True, signal_BF=6.9e-8,
