...
bdt_lh_cut_opt_significance_exclusive_backgrounds.make_final_binning_plot_extra_bkgs_nodata(interp_N_dict,cut_opt_samples=samples_for_cut_opt, lrange_interp_N_dict=(0.999,1) ,hrange_interp_N_dict=(0.999,1),nlh = 200, signal_BF=BF, eventsProcessed_dict = cfg.eventsProcessed , 
                                                    histbins=(2,2), components_to_plot =  samples_allocations, model_all_1prong_leptonic_tau = True, binned_x_axis = np.array([['Signal depleted','Heavy background \n enriched'],['Light background \n enriched','Signal enriched']]),
                                                    plot_signal_components=True,  nMC_plots_path=None, final_plot_path = plotpath, pull_type_plot=True) 

bdt_lh_cut_opt_significance_exclusive_backgrounds.make_final_binning_plot_extra_bkgs_nodata(interp_N_dict,cut_opt_samples=samples_for_cut_opt, lrange_interp_N_dict=(0.999,1) ,hrange_interp_N_dict=(0.999,1),nlh = 200, signal_BF=BF, eventsProcessed_dict = cfg.eventsProcessed , 
                                                    histbins=(2,2), model_all_1prong_leptonic_tau = True, components_to_plot =  ["combined_signal", "Bu2lnu_background","Bc2lnu_background"] , binned_x_axis = np.array([['Signal depleted','Heavy background \n enriched'],['Light background \n enriched','Signal enriched']]),
                                                    plot_signal_components=True,  nMC_plots_path=None, final_plot_path = plotpath, pull_type_plot=False) 

BF = 1e-6
bdt_lh_cut_opt_significance_exclusive_backgrounds.make_final_binning_plot_extra_bkgs_nodata(interp_N_dict,cut_opt_samples=samples_for_cut_opt, lrange_interp_N_dict=(0.999,1) ,hrange_interp_N_dict=(0.999,1),nlh = 200, signal_BF=BF, eventsProcessed_dict = cfg.eventsProcessed , 
                                                    histbins=(2,2),  model_all_1prong_leptonic_tau = True,components_to_plot =  samples_allocations, binned_x_axis = np.array([['Signal depleted','Heavy background \n enriched'],['Light background \n enriched','Signal enriched']]),
                                                    plot_signal_components=True,  nMC_plots_path=None, final_plot_path = plotpath, pull_type_plot=True) 


bdt_lh_cut_opt_significance_exclusive_backgrounds.calculate_BF_sensitivities_extra_bkgs_nodata(interp_N_dict, cut_opt_samples=samples_for_cut_opt, componenets_in_FOM=samples_allocations, model_all_1prong_leptonic_tau = True,  lrange_plot=(0.999,1) ,hrange_plot=(0.999,1), nlh=200 , sig_BFs=np.logspace(-9,-4,250),incl_other_syst=True, incl_toys_fit=True, ntoys=200,plot=True,saveplotpath = plotpath, toyplotpath = os.path.join(plotpath,"toys"), dict_path = dict_path) 
