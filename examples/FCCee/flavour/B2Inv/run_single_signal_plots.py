...
for sample in cfg.sample_allocations['combined_signal']:
    ...
    bdt_lh_cut_opt_with_n_interp.sensitivity_CL_plotter(naive_dict, incl_syst_dict, toys_dict = None, x_label = x_label, comparison_line_CL = BELLEII_CL, BF_plot_min=BF_plot_min,BF_plot_max=BF_plot_max,savepath=os.path.join(plotpath,sample))
